<h2><a href="https://www.geeksforgeeks.org/problems/string-rp-or-pr--170647/1?page=6&company=Google&sortBy=submissions">String rp or pr</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string S. In one operation, you can remove the substring "pr" from the string S and get amount X or you can remove the substring "rp" and get the amount Y.&nbsp;<br>
