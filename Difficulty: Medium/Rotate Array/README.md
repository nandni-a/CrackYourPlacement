...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1&nbsp;<span style="font-size: 18px;">≤ </span>&nbsp;arr.size(), d&nbsp;<span style="font-size: 18px;">≤ </span>&nbsp;10<sup>5</sup></span><br><span style="font-size: 14pt;">0&nbsp;<span style="font-size: 18px;">≤ </span>&nbsp;arr[i]&nbsp;<span style="font-size: 18px;">≤ </span>&nbsp;10<sup>5</sup></span></p></div><p><span style=font-size:18px><strong>Company Tags : </strong><br><code>Amazon</code>&nbsp;<code>Microsoft</code>&nbsp;<code>MAQ Software</code>&nbsp;<code>Codenation</code>&nbsp;<br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Arrays</code>&nbsp;