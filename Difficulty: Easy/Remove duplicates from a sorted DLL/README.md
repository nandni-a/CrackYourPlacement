<h2><a href="https://www.geeksforgeeks.org/problems/remove-duplicates-from-a-sorted-doubly-linked-list/1?utm=codolio">Remove duplicates from a sorted DLL</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a doubly&nbsp;linked list of <strong>n </strong>nodes sorted by values, remove duplicate nodes present in the linked list.</span></p>
